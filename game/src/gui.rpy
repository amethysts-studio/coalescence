...
define gui.default_font = "fonts/Spectral.ttf"

## The font used for character names.
define gui.name_font = "fonts/Spectral.ttf"
...
define gui.text_ypos = 250

## The maximum width of dialogue text, in pixels.
define gui.text_width = 1100 #744
...
define gui.quick_button_borders = Borders(10, 20, 10, 10)
...
define gui.slot_button_height = 480
define gui.slot_button_borders = Borders(20, 20, 10, 10)
...
define gui.history_height = 40

## The position, width, and alignment of the label giving the name of the
## speaking character.
define gui.history_name_xpos = 140
define gui.history_name_ypos = 0
define gui.history_name_width = 140
...
define gui.nvl_borders = Borders(20, 120, 20, 50)
...
define gui.nvl_name_width = 140
define gui.nvl_name_xalign = 1.0

## The position, width, and alignment of the dialogue text.
define gui.nvl_text_xpos = 160
define gui.nvl_text_ypos = 0
define gui.nvl_text_width = 520
define gui.nvl_text_xalign = 0.0

## The position, width, and alignment of nvl_thought text (the text said by the
## nvl_narrator character.)
define gui.nvl_thought_xpos = -50
define gui.nvl_thought_ypos = 0
define gui.nvl_thought_width = 680
define gui.nvl_thought_xalign = 0.0

## The position of nvl menu_buttons.
define gui.nvl_button_xpos = 360#160
...
init python:
    ...
    if renpy.variant("touch"):
        ...
        gui.quick_button_borders = Borders(40, 30, 40, 10)
    ...
    if renpy.variant("small"):
        ...
        gui.nvl_name_width = 140
        gui.nvl_name_xpos = 140

        gui.nvl_text_width = 520
        gui.nvl_text_xpos = 160
        gui.nvl_text_ypos = 0

        gui.nvl_thought_width = 680
        gui.nvl_thought_xpos = -50

        gui.nvl_button_width = 520
        gui.nvl_button_xpos = 420
